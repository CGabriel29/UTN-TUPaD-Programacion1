...
while opcion != 8:
    ...
    match opcion:
        case 1:
            titulos = []
            ejemplares = []
            entrada = input("¿Cuántos títulos desea ingresar? ")
            if entrada.isdigit():
        ...
        case 2:
            if len(titulos) == 0:
                ...
                for i in range(len(titulos)):
                    entrada = input("Ejemplares disponibles de '" + titulos[i] + "': ")
                    if entrada.isdigit():
                        cantidad = int(entrada)
                        if cantidad < 0:
                            cantidad = 0
        ...
        case 6:
            ...
            entrada = input("Ingrese la cantidad de ejemplares: ")
            if entrada.isdigit():
                nuevas_copias = int(entrada)
                if nuevas_copias < 0:
                    nuevas_copias = 0
            else:
                nuevas_copias = 0
